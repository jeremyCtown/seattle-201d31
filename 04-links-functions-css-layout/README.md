...
- Announcements
  ...
  - Friday's Partner Power Hour

  - Career Coaching Assignments

  - Visit from admissions

  - [Please sign up for a time slot](https://alliegrampa.youcanbook.me/) for a one-on-one with me next week. Make sure to use the "Jump To Date" feature to skip to Monday, 1/15/18. We will be reviewing your self-assessment assignment, which is due this Sunday at 11:59 p.m., so please make sure to complete it on time!
...
* The lab time should be divided into two sections of approximately two hours each. At the halfway mark, students should swap roles and work on the other person's code. Watch the clock and determine the best point to swap roles.
