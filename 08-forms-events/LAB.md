...
- Finish creating your table, if lab 7 is not fully functional yet.
- The stretch goal from lab 7 is now required -- make a footer row for your table which contains the total cookies sold per hour.
- Create a form so a user can add a new store to the table. Your table should update to include the new store and the footer row should also update with the new totals and appear at the bottom of the table.
