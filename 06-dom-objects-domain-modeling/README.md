...
- Allie will be in an instructor workshop all afternoon.

- Scheduling one-on-ones

- Feedback from week 1 surveys
...
- JS Chapter 3: "Functions, Objects, and Methods" (p. 100-105)
- JS Chapter 5: "The Document Object Model" (p. 183-242)
